...
@Component({
    ...
    template: ` <div>
    <svg id="candle-stick" #candleStick height="350"></svg>
    </div>`,
    styleUrls: [
    ],
...
export class CandleStickComponent {
    ...
    candleStick=new CandleStickBarChart();
    constructor() {
        var data = [{values: [
        ...
        this.candleStick.data=data;
        this.candleStick.XaxisLabel="Dates";
        this.candleStick.selection="";
        this.candleStick.YaxisTickFormat=',.1f';
        this.candleStick.XaxisTickFormat='%x';
        this.candleStick.YaxisLabel="Stock Price";
        this.candleStick.duration_1=250;
        this.candleStick.duration_2=500;
        this.candleStick.margin_bottom=50;
        this.candleStick.margin_left=70;
        this.candleStick.margin_top=20;
        this.candleStick.margin_right=40;
        this.candleStick.id="candle-stick";
        Utils.candleStickChart(this.candleStick);
    }
    ngOnInit()
    { 
